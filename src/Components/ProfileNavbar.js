...
const ProfileNavbar = ({ title }) => {
    return (
        <nav className="w-full h-14 bg-white relative flex justify-center items-center shadow-sm">
            <button onClick={() => window.history.back()} className="w-7 h-7 text-black absolute left-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293z" clipRule="evenodd" />
                </svg>
            </button>
            <h2 className="text-xl font-bold">{title}</h2>
            <Link to="/logout" className="h-7 text-red-500 flex items-center absolute right-4">
